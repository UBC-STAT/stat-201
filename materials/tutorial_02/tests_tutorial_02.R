...
test_2.0 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(apt_ages$age_yrs))), "3d50b3dbabfa26a0c9b6cb018a0e112d")
  })
  print("Success!")
}
...
test_2.1 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(round(sum(apt_age_dist$data$age_yrs))), "d06c71a5d34a5e93eece937c601f8d95")
  })
...
test_5.2 <- function() {
  ...
  answer_hash <- digest(tolower(answer5.2))
  if (answer_hash == "127a2ec00989b9f7faf671ed470be7f8") {
    print("Re-read the scenario above; do we have the resources to do this?")
  } else if (answer_hash == "ddf100612805359cd81fdc5ce3b9fbba") {
    print("What is the definition of standard error?")
  } else if (answer_hash == "d110f00cfb1b248e835137025804a23b") {
