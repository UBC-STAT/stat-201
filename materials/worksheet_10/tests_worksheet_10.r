...
test_3.1 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(mean_body_mass_chinstrap_ci$lower_ci) * 1000)), "bd945032d1d87b6a09020351c6200720")
    expect_equal(digest(as.integer(sum(mean_body_mass_chinstrap_ci$upper_ci) * 1000)), "b5e210667d3602aba17f4f170d859f57")
  })
...
test_4.5 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(prob_multiple_tests$prop_error_type_1) * 10e3)), "c9349ffd712f18a95358518b997e4971")
  })
