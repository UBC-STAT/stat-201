...
test_2.2 <- function() {
  ...
  test_that("Plot does not have the correct layers", {
    expect_true("GeomLine" %in% class(sequential_pvalue$layers[[2]]$geom))
  })
...
# Question 2.5.1
test_2.5.1 <- function() {
  test_that('Did not assign answer to an object called "answer2.5.1"', {
    expect_true(exists("answer2.5.1"))
  })

  answer_as_numeric <- as.numeric(answer2.5.1)
  test_that("Solution should be a number", {
    expect_false(is.na(answer_as_numeric))
  })

  test_that("Solution is incorrect", {
    expect_equal(digest(as.integer(100*answer_as_numeric)), "dd4ad37ee474732a009111e3456e7ed7")
  })
...
test_that("The number of expected rejections is incorrect", {
    expect_equal(digest(as.integer(answer2.5$expected_n_rejections)), "dd4ad37ee474732a009111e3456e7ed7")
  })
...
test_3.1.2 <- function() {
  ...
  test_that("The number of expected rejections is incorrect", {
    expect_equal(digest(as.integer(answer3.1.2$expected_n_rejections)), "dd4ad37ee474732a009111e3456e7ed7")
  })
...
test_3.2.1 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(100*crit_bonferroni)), "57cd4574292fec5b2b517c39404a7800")
  })
...
test_3.2.3 <- function() {
  ...
  test_that("The number of expected rejections is incorrect", {
    expect_equal(digest(as.integer(answer3.2.3$expected_n_rejections)), "dd4ad37ee474732a009111e3456e7ed7")
  })
