...
test_1.6 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(layer_data(max_flow_result_plot,2)), "d81df9b5725a6921d5b4622eccc22c7b")
...
test_1.11 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(mean_max_flow_ci$lower_ci) * 10e6)), "a4032cdef8c2b688bb01ff5b0ddddb7d")
    expect_equal(digest(as.integer(sum(mean_max_flow_ci$upper_ci) * 10e4)), "c670fbe8dc5444d2e457cbf4f4991c1e")
  })
...
test_3.1 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(obs_diff_prop$stat) * 10000)), "66d6993ee8dae6d5c6069a605b87af98")
  })
