...
test_1.3 <- function() {
  ...
  test_that('Did not assign answer to an object called "variance"', {
  ...
  test_that('Did not assign answer to an object called "quantile"', {
    expect_true(exists("quantile"))
  })

  answers <- c(mean, proportion, median, variance, standard_deviation, quantile) %>%
    map(as.numeric)
  ...
  test_that("At least one term-definition match is incorrect", {
    expect_equal(digest(as.numeric(mean)), "dbc09cba9fe2583fb01d63c70e1555a8")
    ...
    expect_equal(digest(as.numeric(standard_deviation)), "5e338704a8e069ebd8b38ca71991cf94")
    expect_equal(digest(as.numeric(quantile)), "0aee9b78301d7ec8998971363be87c03")
  })
...
test_3.2 <- function() {
  ...
  test_that("Solution should be a number", {
    expect_false(is.na(as.numeric(answer3.2)))
  })

  test_that("Solution is incorrect", {
    expect_equal(digest(floor(answer3.2)), "53849aef7ad3a06c28f3031fab4ef6fc")
  })
...
test_3.3 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", "C", or "D")', {
    expect_match(answer3.3, "a|b|c|d", ignore.case = TRUE)
  })
  
  answer <- digest(tolower(answer3.3))
  if (answer == "127a2ec00989b9f7faf671ed470be7f8") {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer3.3)), "6e7a8c1c098e8817e3df3fd1b21149d1")
  })
...
test_3.5 <- function() {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer3.5)), "05ca18b596514af73f6880309a21b5dd")
  })
  print("Success!")
}
...
test_3.6 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", or "C")', {
    expect_match(answer3.6, "a|b|c", ignore.case = TRUE)
  })
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer3.6)), "127a2ec00989b9f7faf671ed470be7f8")
  })
...
test_4.3 <- function() {
  ...
  if (answer == "d2a90307aac5ae8d0ef58e2fe730d38b") {
    print("Compare the proportions of each type of worker in the sample to their proportion of the population.")
  }
