...
test_1.5 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
      expect_equal(digest(as.integer(round((salmon_btsp_ci$lower_ci+salmon_btsp_ci$upper_ci) * 10e6))), "fb5b4cfa92f99a2bd9d0e750ce5e989f")
  })
...
test_2.1 <- function() {
  ...
  expected_colnames <- c("geo_local_area", "n", "sample_mean", "sample_std_error")
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(sum(parking_summary$n)), "e1c87205446e1c8cc10879d9851cd008")  
...
test_2.3 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(parking_multiple_ci$lower_ci))), "5f80a2fefde46c5f55850375f0330dae")
    expect_equal(digest(as.integer(sum(parking_multiple_ci$upper_ci))), "48139aad2994737e7e801156a24281ed")
...
test_4.4 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
      expect_equal(digest(as.integer(round((diff_in_props_btsp_ci$lower_ci+diff_in_props_btsp_ci$upper_ci) * 10e6))), "2613272d9788702e8555b36d13344633")
  })
