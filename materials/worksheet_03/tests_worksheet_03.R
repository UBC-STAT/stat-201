...
test_1.2 <- function() {
  ...
  if (answer == "127a2ec00989b9f7faf671ed470be7f8") {
    print("The standard error is not the standard deviation of the population distribution'")
  } else if (answer == "ddf100612805359cd81fdc5ce3b9fbba") {
    print("The standard error is not the standard deviation of the sample distribution'")
  } else if (answer == "6e7a8c1c098e8817e3df3fd1b21149d1") {
    print("The number of possible samples does not tell us how much the point estimates will vary")
  }
...
test_2.4 <- function() {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer2.4)), "d110f00cfb1b248e835137025804a23b")
  })
...
test_2.5 <- function() {
  ...
  test_that('Solution should be "true" or "false"', {
    expect_match(answer2.5, "true|false", ignore.case = TRUE)
  })
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer2.5)), "d2a90307aac5ae8d0ef58e2fe730d38b")
  })
...
test_3.2.5 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(round(sum(samples_houseflies$wings_length) * 10))), "83f712ff5e2b3b020f2c03a0d11281d3")
  })
...
test_3.3.1 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(samples_size10$value)*1000)), "c7292f8c5d4b491baa81c5c7af2a632e")
  })
...
test_3.3.2 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(round(sum(sampling_dist_size10$data$sample_mean))), "7d92de4f1329e585c6d7feb62bffcd1b")
  })
...
test_3.3.3 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(samples_size500$value)*100)), "16d38c4a013299fc9acc4237ab219f90")
  })
...
test_3.3.4 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(round(sum(sampling_dist_size500$data$sample_mean))), "42fa866d45d4eef7c096475f74c7c5ec")
  })
...
test_3.3.5 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(round(sum(sampling_dist_min$data$sample_min))), "a5aefec9259b4084419f627f769b9a53")
  })
