...
test_2.2 <- function() {
  ...
  if (digest(tolower(answer2.2)) != "d2a90307aac5ae8d0ef58e2fe730d38b") {
    print("The distribution is not symmetrical and does not appear to be shaped like a bell.")
  }
...
test_4.1 <- function() {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(tolower(answer4.1)), "6e7a8c1c098e8817e3df3fd1b21149d1")
  })
