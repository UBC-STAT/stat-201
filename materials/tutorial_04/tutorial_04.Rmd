...
```{r deletable=FALSE, nbgrader={'cell_type': 'code', 'checksum': 'defe590fe055c73e6f911de6ecb82cea', 'grade': False, 'grade_id': 'cell-fa279e7c87ba536d', 'locked': False, 'schema_version': 3, 'solution': True, 'task': False}}
# your code here
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "fd266d9ca666ec5392f50a66961f7576", "grade": false, "grade_id": "cell-6e83465e672d5f4a", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
**Question 1.1** 
<br> {points: 1}
...
```{r deletable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '4d91b6b44ebf5c30e0e4f55d1fb56609', 'grade': False, 'grade_id': 'cell-b15be21c9148990e', 'locked': False, 'schema_version': 3, 'solution': True, 'task': False}}
...
```{r deletable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '670d26f008167559c8c7301d128bd531', 'grade': False, 'grade_id': 'cell-fb44dfe96bbfc3e2', 'locked': False, 'schema_version': 3, 'solution': True, 'task': False}}
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '6c4415d8a5aec418f9107d3fb0d5555b', 'grade': True, 'grade_id': 'cell-8e27b4947d4866fb', 'locked': True, 'points': 1, 'schema_version': 3, 'solution': False, 'task': False}}
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "176c8c20ef7f72bebc5fb474dcae51cc", "grade": false, "grade_id": "cell-26332d818a4387fa", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
**Question 2.1**
<br>{points: 1}
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '9f3d9b7eca19aa91074726481b195095', 'grade': True, 'grade_id': 'cell-1c527e7a33c44b58', 'locked': True, 'points': 1, 'schema_version': 3, 'solution': False, 'task': False}}
# Here we check to see if you have given your answer the correct object name
# and if your answer is plausible. However, all other tests have been hidden
# so you can practice deciding when you have the correct answer.
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "59c10a1e2e63fdc78f6ebcdcb371813e", "grade": false, "grade_id": "cell-ede7d2d839cfd7d4", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '264de0861282cf155f80a526fe692a06', 'grade': False, 'grade_id': 'cell-bd77bcb71614f9ea', 'locked': True, 'schema_version': 3, 'solution': False, 'task': False}}
# Run this cell before continuing.
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "8cf3095d95de7f39a0c10c4a40daa35c", "grade": false, "grade_id": "cell-c6f632ef113e101b", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
**Question 3.1**
<br>{points: 3}
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "c63b08b0eaf03c135810545fc1be74f8", "grade": false, "grade_id": "cell-0654e2f42a6a3bc0", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
**Question 3.2**
<br>{points: 3}
...
<!-- #region deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "85ef64954d9286a02648c326d3bb5e51", "grade": false, "grade_id": "cell-38ba2cf206a30f11", "locked": true, "schema_version": 3, "solution": false, "task": false} -->
**Question 3.3**
<br> {points: 3}
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '26733256d3d6d726278d2be915180390', 'grade': True, 'grade_id': 'cell-3eb0b62c08bdfbe9', 'locked': True, 'points': 1, 'schema_version': 3, 'solution': False, 'task': False}}
# Here we check to see if you have given your answer the correct object name
# and if your answer is plausible. However, all other tests have been hidden
# so you can practice deciding when you have the correct answer.
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': 'b9c8d89fc1eca272b79a9ea4ae5cd580', 'grade': True, 'grade_id': 'cell-2c25ad9596dad135', 'locked': True, 'points': 1, 'schema_version': 3, 'solution': False, 'task': False}}
# Here we check to see if you have given your answer the correct object name
# and if your answer is plausible. However, all other tests have been hidden
# so you can practice deciding when you have the correct answer.
...
```{r deletable=FALSE, editable=FALSE, nbgrader={'cell_type': 'code', 'checksum': '25ca65c55b35cb478c4100f649bf87ea', 'grade': True, 'grade_id': 'cell-8375139f411d5d82', 'locked': True, 'points': 1, 'schema_version': 3, 'solution': False, 'task': False}}
# Here we check to see if you have given your answer the correct object name
# and if your answer is plausible. However, all other tests have been hidden
# so you can practice deciding when you have the correct answer.
