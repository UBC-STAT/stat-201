...
test_3.1.7 <- function() {
  ...
  test_that("Wrong p-value", {
    expect_equal(digest(as.integer(answer3.1.7$p.value*10e6)), "1d11033765941c4c743aea978995f7b9")
  })
  ...
  test_that("Wrong alternative hypothesis", {
    expect_equal(digest(answer3.1.7$alternative), "0ff92e9c2aed54e21f95489292c00267")
  })
...
test_3.3.6 <- function() {
    test_that("Solution is incorrect", {
    expect_equal(digest(as.integer(answer3.3.6$statistic * 1e4)), "e47bfc8d29582ccabd240e69c9207fdb")
...
test_3.4.1 <- function() {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(as.integer(answer_as_numeric * 10e6)), "ecab2c771b06e4fb098330edbff6d458")
  })
...
test_3.4.4 <- function() {
  ...
  test_that("Wrong statistic value", {
    expect_equal(digest(as.integer(answer3.4.4$statistic*10e6)), "52cab2c6769032c1d133ee66327141d3")
  })
...
test_3.5.5 <- function() {
  ...
  test_that("Solution is incorrect", {
    expect_equal(digest(as.integer(answer_as_numeric * 10e11)), "d442c76874a37fa5a49158228fb04313")
  })
...
test_3.5.7 <- function() {
  ...
  test_that("Wrong p-value", {
    expect_equal(digest(as.integer(answer3.5.7$p.value*10e6)), "4b5630ee914e848e8d07221556b0a2fb")
  })
  test_that("Wrong estimate", {
  ...
  test_that("Wrong alternative hypothesis", {
    expect_equal(digest(answer3.5.7$alternative), "d095e00cba6f80bf1d5ad5db0400f812")
  })
