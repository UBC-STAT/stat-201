...
test_1.2 <- function() {
  ...
  if (answer_hash == "05ca18b596514af73f6880309a21b5dd") {
    print("Do you use the null model to construct a confidence interval for the population mean?")
  }
...
test_2.1.2 <- function() {
  ...
  if (answer_hash == "ddf100612805359cd81fdc5ce3b9fbba") {
    print("Look at the table above that shows the true population parameters from the simulated populations.")
  }
...
test_3.2 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    ...
    expect_equal(digest(as.integer(sum(answer3.2$conf.low) * 1000)), "06eccdb3e477ed83195b3770c2de2751")
    expect_equal(digest(as.integer(sum(answer3.2$conf.high) * 1000)), "a8f21a785cb1bdb766c496785f439e6b")
  })
