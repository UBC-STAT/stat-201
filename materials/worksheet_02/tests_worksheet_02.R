...
test_4.2 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(as.integer(bootstrap_dist_10$data$mean_land_value)), "8e9de07027c98c2fa1159dd619caddf0")
  })
...
test_4.4 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(sample_30$current_land_value))), "4a5ecc6ec727316a8c66a06e40fa8bbf")
  })
  print("Success!")
}
...
test_4.5 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(as.integer(sum(bootstrap_dist_30$data$mean_land_value))), "eef078143eaa1777915f658246b8b91e")
  })
...
test_4.6 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(sample_100$current_land_value))), "efb971245d4570e29ad21cd8ae95160b")
  })
...
test_4.7 <- function() {
  ...
  test_that("Plot does not use the correct data", {
    ...
    expect_equal(digest(as.integer(sum(bootstrap_dist_100$data$mean_land_value))), "546fe7f7dc9becadac2153d9197ab65b")
  })
