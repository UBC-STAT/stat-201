...
test_1.3 <- function() {
  ...
  answers <- c(mean, proportion, median, variance, standard_deviation, correlation) %>%
    map(as.numeric)
  ...
  test_that("At least one term-definition match is incorrect", {
    ...
    expect_equal(digest(as.numeric(standard_deviation)), "0aee9b78301d7ec8998971363be87c03")
