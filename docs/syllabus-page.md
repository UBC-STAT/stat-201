...
- Lectures and Tutorials are on Monday and Wednesday from 4:00pm to 5:20pm
    - Because of holidays during the term, it's hard to have consistancy for lecture and tutorial days. Please refere the canvas course page to see the lecture day and the tutorial day for each week.
- Location: CHEM B250
